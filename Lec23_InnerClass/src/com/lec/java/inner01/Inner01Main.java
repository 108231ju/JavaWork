...
public class Inner01Main {
	...
	public static void main(String[] args) {
		...
		// 새로운 외부 클래스 인스턴스 생성
		// out2 외부 클래스 인스턴스 생성
		// out2로부터  in4,in5 라는 이름으로 내부 클래스 객체 만드세요.
		System.out.println();
		TestOuter out2 = new TestOuter(150);
		
		TestOuter.TestInner in4 = out2.new TestInner(200);
		in4.printInnerValue();
		in4.printOuterValue();
		
		TestOuter.TestInner in5 = out2.new TestInner(300);
		in5.printInnerValue();
		in5.printOuterValue();
