...
public class Variable02Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("byte: " + Short.MIN_VALUE + " ~ " + Short.MAX_VALUE);
		short num5 = -12345;
		short num6 = 12345;
		//short num7 = 32768;
		//short num8 = -32769;
...
//		long num10 = 9876543210;	// The literal 9876543210 of type int is out of range
		// 리터럴 : literal
		// 	코드상에 직접 입력한 값들
		// 	 정수리터널 --> int로 형변환 하려 한다
		//	  실수 리터널 --> double 로 형변환 하려 한다.
		// 		"~" 리터널 --> 문자열(string) 로 형변환
		
		long num11 = 9876543210L;	// <-- long 형 리터널로 인식
		long num12 = 12;
		long num13 = 12L;
		int num14 = 12;
//		int num15 = 12L; //에러 long  타입은 int에 대입 불가
		...
		System.out.println("number1= " + Integer.toHexString(number1)); //16진수 문자열로 변환
