...
public class RegExp03Main {
	...
	public static void main(String[] args) {
		...
		arrInput = new String[] {
				...
				"xbz",				
				"xyyz",
				"xyyz x1y xyyy xxxyyyxxyxyxyyyx xyyxxx xyyyy xyyxyxy xyxyxyx xyyxxy "
		...
		regex = "[abc]"; // a또는 b또는 c 중의 한 문자에 매칭
		arrInput = new String[] {
				"able",	 // 2	 //1
				"bible", // 2	 //2
				"cable", // 3	 //1
		...
		arrInput = new String[] {
				...
				"ab",
				"xyz",
				"abccbbcccbbaaabcccbbaacbaaaccc"
		};
		regex = "(a|b)+";
