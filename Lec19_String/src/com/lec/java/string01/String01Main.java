...
public class String01Main {
	...
	public static void main(String[] args) {
		...
		System.out.println();
		System.out.println("1. length()");  // 문자의 개수
		System.out.println("str1 길이: " + str1.length());
		System.out.println("str2 길이: " + str2.length());
		
		System.out.println();
		System.out.println("2. concat()");  // 문자열 연결 (concatenation)
		...
		str1 = str1.concat(str2); //변경하려면 이와 같이 덮어쓰기 해야한다.
		...
		System.out.println();
		System.out.println("3. charAt(index)"); // 문자열 안의 특정위치(index)의 문자 리턴, 인덱스 범위 벗어나면 StringIndexOutOfBoundsException
											// 문자열 인덱스는 0 부터 시작!
		System.out.println(str1.charAt(0));
		System.out.println(str1.charAt(1));
		//System.out.println(str1.charAt(20)); // java.lang.StringIndexOutOfBoundsException
		
		
		System.out.println();
		System.out.println("4. indexOf(char), indexOf(String)"); // 문자열 안에서 특정 문자(char) 혹은 문자열(String)의 위치(index), 발견 못하면 -1 리턴
		...
		System.out.println();
		System.out.println("5. toUpperCase(), toLowerCase");  // 대문자 변환, 소문자 변환
		System.out.println(str1.toUpperCase());
		System.out.println(str1.toLowerCase());
		
		System.out.println();
		System.out.println("6. startWith()");  // 문자열이 주어진 prefix문자열로 시작하는지 여부 true/false 리턴
		String prefix = "http://";
		...
		System.out.println();
		System.out.println("7. split(regex)"); // 문자열을 주어진 문자열로 쪼개어 String[] 리턴
		...
		System.out.println();
		System.out.println("8. String.join(delimeter, elements ...)");
		String[] str7 = {"Alice", "Bob", "Carol"};
		System.out.println (String.join(" - ", str7));
		
		
		System.out.println();
		System.out.println("9. substring(beginIndex, endIndex)");  // 문자열의 일부분 추출 beginIndex ~ endIndex직전 까지,  인덱스 범위 벗어마면 IndexOutOfBoundsException 
		String str8 = "Hello Java";
		System.out.println(str8.substring(2, 5));   // 2부터 5 까지
		System.out.println(str8.substring(6)); 		// 6부터 끝까지
			
		
		System.out.println();
		System.out.println("10. trim()");   // 좌우의 여백 제거
		String str9 = "   김동후   ";
		...
		System.out.println();
		System.out.println("11. replace(target, replacement)");   // 문자열 치환  target → replacement  
		...
		System.out.println();
		System.out.println("12. replaceAll(regex, replacement), replaceFirst(regex, replacement)"); // 정규표현식 사용버젼  , replaceAll() 매칭되는것 전부 치환, replaceFirst() 첫매칭만 치환
		System.out.println(str10.replaceAll("Language", "자바"));
		System.out.println(str10.replaceFirst("Language", "자바"));
				
		System.out.println();
		System.out.println("13. equals(), equalsIgnoreCase()");  // 문자열 비교
		String str11 = "Java";
		String str12 = "java";
		// TODO
		
		System.out.println();
		System.out.println("14. String.format()");
		// TODO
